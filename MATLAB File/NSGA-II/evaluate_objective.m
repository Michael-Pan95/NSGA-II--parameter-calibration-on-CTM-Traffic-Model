function f = evaluate_objective(x, M, V,density0,input_flow,exit_density1,exit_ratio1,enter_flow1,enter_ratio1,...
...
%这里开始调用PI函数
% sum = 0;
    [f1,f2] =PI(x,density0,input_flow,exit_density1,exit_ratio1,enter_flow1,enter_ratio1,...
    enter_flow2,enter_ratio2,output_density,flow_data,speed_data,hours);
